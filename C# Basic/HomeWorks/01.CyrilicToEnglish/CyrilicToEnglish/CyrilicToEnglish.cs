...
namespace ConsoleApplication3
{
    class CyrilicToEnglish
    {
        ...
        public static void Main(string[] args)
        {
            ...
            string[] produkti = Console.ReadLine().Split(' ');
            string noviprodukti = produkti.ToString();
            Convert.ToString(noviprodukti);
